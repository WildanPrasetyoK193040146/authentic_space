        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ url('/dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{asset('backend/assets/images/logo.jpg')}}" alt="logo-sm" height="60">
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset('backend/assets/images/logo.jpg')}}" alt="logo-dark" height="60">
                    </span>
                </a>

                <a href="{{ url('/dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{asset('backend/assets/images/logo.jpg')}}" alt="logo-sm-light" height="60">
                    </span>
                    <span class="logo-lg">
